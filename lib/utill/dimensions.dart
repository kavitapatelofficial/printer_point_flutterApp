...
class Dimensions {
  static  double fontSizeExtraSmall = ResponsiveHelper.isTab(Get.context) ? 12 : 10.0;
  static  double fontSizeSmall = ResponsiveHelper.isTab(Get.context) ? 14 : 14.0;
  static  double fontSizeDefault = ResponsiveHelper.isTab(Get.context) ? 12 : 12.0;
  static  double fontSizeLarge = ResponsiveHelper.isTab(Get.context) ? 16 : 12.0;
  static  double fontSizeExtraLarge = ResponsiveHelper.isTab(Get.context) ? 20 : 18.0;
  static  double fontSizeOverLarge = ResponsiveHelper.isTab(Get.context) ? 20 : 19.0;
  ...
  static const double paddingSizeDefault = 10.0;

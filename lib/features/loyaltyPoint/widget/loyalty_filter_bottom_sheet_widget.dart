...
class LoyaltyFilterBottomSheetWidget extends StatefulWidget {
  ...
  @override
  State<LoyaltyFilterBottomSheetWidget> createState() =>
      _LoyaltyFilterBottomSheetWidgetState();
}

class _LoyaltyFilterBottomSheetWidgetState
    extends State<LoyaltyFilterBottomSheetWidget> {
                ...
                child: SizedBox(
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return InkWell(
                          onTap: () => loyaltyProvider.setSelectedProductType(
                              ...
                              decoration: BoxDecoration(
                                border: Border.all(
                                    color: filterTypeList[index] ==
                                            loyaltyProvider.selectedFilterBy
                              ...
                              child: Center(
                                ...
                                child: Text(
                                    ...
                                    style: textRegular.copyWith(
                                      color: loyaltyProvider.selectedFilterBy ==
                ...
                onTap: () async {
                  DateTimeRange? pickedRange = await showDateRangePicker(
                    ...
                    initialDateRange: DateTimeRange(
                      start: loyaltyProvider.startDate ?? DateTime.now(),
                      end: loyaltyProvider.endDate ??
                          DateTime.now().add(Duration(days: 7)),
                    ),
                  );

                  if (pickedRange != null) {
                    loyaltyProvider.setSelectedDate(
              ...
              Container(
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) => _FilterItem(
                    title: getTranslated(
                        AppConstants.loyaltyEarnTypeList[index], context),
                    checked: loyaltyProvider.selectedEarnByList?.contains(
                            AppConstants.loyaltyEarnTypeList[index]) ??
                        false,
                    onTap: () => loyaltyProvider.onUpdateEarnBy(
                        AppConstants.loyaltyEarnTypeList[index]),
                  ),
                ),
              ),
                ...
                onTap: _canFilter()
                    ? () {
                        loyaltyProvider.getLoyaltyPointList(
                          ...
                          1,
                          transactionTypes:
                              loyaltyProvider.selectedEarnByList?.toList(),
  ...
  bool _canFilter() {
    ...
    final areTransactionTypesEqual = loyaltyProvider
                .selectedEarnByList?.length ==
            loyaltyProvider.loyaltyPointModel?.transactionTypes?.length &&
        loyaltyProvider.selectedEarnByList?.toSet().containsAll(
                loyaltyProvider.loyaltyPointModel?.transactionTypes?.toSet() ??
                    {}) ==
            true;
    ...
    return !(areTransactionTypesEqual) ||
        ...
        loyaltyProvider.startDate !=
            loyaltyProvider.loyaltyPointModel?.startDate ||
        loyaltyProvider.selectedFilterBy !=
            loyaltyProvider.loyaltyPointModel?.filterBy;
  }
  ...
  bool _isClearFilterData(LoyaltyPointModel? loyaltyModel) {
    return loyaltyModel?.startDate != null ||
        ...
        (loyaltyModel?.filterBy != null &&
            (loyaltyModel?.filterBy?.isNotEmpty ?? false));
  }
}

  ...
  return PopScope(
    ...
    onPopInvoked: (didPop) async {
      if (Navigator.of(context).canPop()) {
        if (Provider.of<RestockController>(context, listen: false).restockProductModel != null &&
            Provider.of<RestockController>(context, listen: false).restockProductModel?.data == []) {

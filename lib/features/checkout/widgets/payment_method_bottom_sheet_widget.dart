                              ...
                              Padding(
                                  ...
                                  child: Container(
                                      decoration: BoxDecoration(
                                        color: checkoutController.isOfflineChecked?Theme.of(context).primaryColor.withOpacity(.15): null,
                                      ...
                                      child: Column(children: [
                                        ...
                                        InkWell(
                                          ...
                                          child: Padding(padding: const EdgeInsets.all(8.0), child: Container(
                                            ...
                                            child: Row(children: [
                                              Theme(
                                                data: Theme.of(context).copyWith(unselectedWidgetColor: Theme.of(context).primaryColor.withOpacity(.25)),
                                                child: Checkbox(

        ...
        return isCodeChecked ? Padding(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
                ...
                border: Border.all(width: 1, color: Theme.of(context).hintColor.withOpacity( .125),),
              ...
              SizedBox(height: 40, child: Center(
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    enabledBorder: OutlineInputBorder(borderSide: BorderSide(color: Theme.of(context).hintColor.withOpacity( .5), width: 1)),
                    focusedBorder: OutlineInputBorder(borderSide: BorderSide(color: Theme.of(context).hintColor.withOpacity( .5), width: 1)),
